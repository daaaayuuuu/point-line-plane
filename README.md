...
### 1. 提出点子：澄清需求，查看完整 PRD

左侧回顾柠檬项目的需求对话，右侧查看产品目标、使用流程和需求文档。

![柠檬项目需求对话与 PRD](media/demo-idea.png)

### 2. 确认方案：操作低保真原型

通过页面故事板查看首页、时长设置等关键界面，体验按钮和页面切换。

![柠檬项目低保真原型与页面说明](media/demo-solution.png)

### 3. 生成预览：体验柠檬番茄闹钟

在内嵌预览中操作专注计时，查看完成提醒和当日次数记录。

![柠檬番茄闹钟交互预览](media/demo-preview.png)

### 4. 部署上线：查看已完成的发布结果

左侧展示案例发布记录和产品缩览，右侧展示七步上线流程的完成状态。

![柠檬项目发布结果与七步完成状态](media/demo-launch.png)
